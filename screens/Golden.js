...
export default function Golden({ navigation, resumenes, setResumenes }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {!isSummary ? (
        <>
          <Text style={styles.sectionTitle}>Selecciona un Taco Golden:</Text>
          {Object.entries(menuData.tacosGolden).map(([nombre, taco], index) => (
        ...
        <View style={styles.summary}>
          <Text style={styles.sectionTitle}>Resumen de tu Taco Golden:</Text>
