...
export default function Vegetarianos({ navigation, resumenes, setResumenes }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {!isSummary ? (
        <>
          <Text style={styles.sectionTitle}>Selecciona un Taco Vegetariano:</Text>
          {Object.entries(menuData.vegano).map(([nombre, taco], index) => (
        ...
        <View style={styles.summary}>
          <Text style={styles.sectionTitle}>Resumen de tu Taco Vegano:</Text>
